            ...
            return (
              ...
              >
                ...
                <Box sx={{ ml: 4, width: '100%', display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <Box sx={{ mr: 2, display: 'flex', flexDirection: 'column', flexBasis: '30%' }}>
                    <Typography sx={{ mb: 0.5, fontWeight: 600, fontSize: '0.875rem' }}>{item.totalAcumulado}</Typography>
                    <Typography variant='caption'>{item.totalAcumuladoCredito}</Typography>
                  </Box>
                  <Box sx={{ mr: 2, display: 'flex', flexDirection: 'column', flexBasis: '30%' }}>
                    <Typography sx={{ mb: 0.5, fontWeight: 600, fontSize: '0.875rem' }}>{item.total}</Typography>
                  </Box>
                </Box>
              </Box>
            )
